    ...
    return (
        <>
            <h1 className='mb-2 font-normal text-[16px] leading-6'>
                {heading}</h1>
            <ol className="space-y-4 list-decimal list-inside text-[14px] font-normal leading-6 text-[#FFF] ml-[10px]">
                            ...
                            <ul className="ps-5 mt-2 space-y-1 list-inside"
                                ...
                                {Object.keys(information[itemText][insideText]).length > 0 &&
                                 Object.keys(information[itemText][insideText]).map((liText, liIndex = 0) => (
                                     ...
                                     <ul className="ps-5 mt-2 space-y-1 list-disc list-inside" key={liIndex}>
                                         <div className='flex'>
                                             <li></li>
                                         ...
                                         {Object.keys(information[itemText][insideText][liText]).length > 0 &&
                                            Object.keys(information[itemText][insideText][liText]).map((
                                                ...
                                                <ul className="ps-5 mt-2 space-y-1 list-circle list-inside" key={liIndexLast}>
                                                    <div className='flex'>
                                                        <li></li>
