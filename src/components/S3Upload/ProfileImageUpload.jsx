                ...
                ? <div className='flex gap-6 mb-[25px]'>
                    <div className="relative mt-[10px]">
                        <img
                            ...
                            className="relative w-[100px] h-[100px] rounded-3"
                        />
                        <Image
                            src="deleteProfile"
                    ...
                    <div className='mt-auto'>
                        <div className="checkbox w-full flex justify-start items-center gap-2 relative mt-[6px]">
                            <input
                                type="checkbox"
                                onClick={(e) => {
     ...
     {loadingImg ? <ImageLoader/> :
                                    ...
                                    />
                                       <input
                                        ...
                                        type="file" className="h-full w-full opacity-0 absolute" name=""/>
