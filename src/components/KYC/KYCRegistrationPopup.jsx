            ...
            <Modal center open={isModalOpen} onClose={handleClose} closeIcon={<Image src='x'/>} styles={{ modal: { borderRadius: 10 } }} >
                <div className='bg-[#3B2A6F] w-[700px] h-[600px] p-10 rounded'>
                    ...
                    <div className='ml-2 text-[#FFF] text-[14px] leading-6 font-normal'>
                        ...
                        <p className='mt-6'>
                            1. Every reporting institution shall apply a risk-based approach in identifying its customers in
                            accordance with section 21 of the Act;</p>
                        <p className='mt-6'>
                            2. In applying the requirements of sub-regulation (1), every reporting institution shall ensure that
                        ...
                        <p className='mt-6'>
                            3. Where a reporting institution identifies lower risks, the reporting institution may decide to allow
                            ...
                            crime;                        </p>
                        <p className='mt-6'>
                            4. Every reporting institution shall ensure that the results of the institution’s risk assessment are
