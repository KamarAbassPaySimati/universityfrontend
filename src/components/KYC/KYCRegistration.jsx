...
export default function KYCRegistration () {
    return (
        <div className='flex w-full py-8 px-10 h-heightFullWithPadding'>
            ...
            <div className='w-[60%] bg-[#ffffff] px-[80px]'>
                ...
                <button
                    className='w-full rounded text-[#F6F8F9]
                                    mt-2 bg-primary-normal font-normal p-1 text-[14px] leading-[22px]'
                    testId='kyc-btn'
                >Proceed</button>
                <p className="ml-[40px] text-neutral-primary text-[12px]
                        leading-[20px] font-normal cursor-pointer mb-[36px]">
                    Paymaart's
                    <span className='text-neutral-primary'>KYC Registration process</span>
