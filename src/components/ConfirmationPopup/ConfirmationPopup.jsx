...
export default function ConfirmationPopup ({ message, title, handleSubmit, isLoading, handleClose, buttonColor, buttonText }) {
    return (
        <div className="p-6 w-full bg-white rounded-[8px]" data-testid="modal">
            ...
            <div className="flex mt-8 gap-6 ml-[288px]">
