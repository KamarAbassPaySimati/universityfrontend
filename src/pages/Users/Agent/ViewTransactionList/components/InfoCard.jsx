...
const InfoCard = ({
    ...
    return (
        <div data-testid={testId} className={`${bgColor} ${title === 'Wallet Balance' ? 'py-[22px]' : 'pt-[22px] pb-2'} ${(type === 'customers' || type === 'merchants') ? 'w-full' : 'w-1/2'} px-10 relative rounded-md text-white flex flex-col justify-between min-h-[156px]`}>
