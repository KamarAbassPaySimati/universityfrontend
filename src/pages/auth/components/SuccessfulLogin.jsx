...
const SuccessfulLogin = ({ handleFetchUserAttributes }) => {
    const handleDone = () => {
        ...
        <>
            <div className='border border-neutral-outline max-w-[627.5px] gap-[27px] rounded-[8px] mb-10 flex p-12'>
                ...
                <div className='flex flex-col items-start justify-center font-[400]'>
                    <h1 data-testid="2FA-enabled-header" className='text-[20px] leading-[28px] text-[#000000]'>
                        Successfully Enabled
                    </h1>
                    <p data-testid="2FA-enabled-content" className='text-[14px] leading-[24px] text-neutral-secondary'>
