...
const UpdatePassword = () => {
    return (
        <CardHeader activePath='Update Password' paths={['Profile']} pathurls={['profile']} testId='update_password_card'>
            ...
            <div className='flex justify-center items-center  mt-[60px] mb-22'>
                <UpdateToNewPassword />
            </div>
            <div className='left-0 ml-[20px] mb-5 mt-22 w-max max-w-[calc(100vw-90px)] break-words place-self-start pt-[84px]'>
                <h1 className='text-[#000] font-[500] text-[16px]'>Note: Password Guidelines</h1>
                <ul className='text-[#000] font-[400] text-[14px] marker:text-[#000] list-outside list-disc ml-6'>
