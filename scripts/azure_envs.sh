...
specific_params=("ADMIN_COGNITO_USERPOOL_ID" "ADMIN_COGNITO_CLIENT_ID" "ADMIN_S3_BUCKET" "ADMIN_DISTRIBUTION_ID" "ADMIN_COGNITO_IDENTITY_POOL_ID" "DOMAIN_NAME" "BUCKET_NAME" "CDN_URL" "PASSWORD_SECRET_KEY" "ADMIN_COGNITO_IDENTITY_POOL_ID" "REGION" "APPLICATION_ID" "ENVIORNMENT_ID" "CONFIGURATION_ID" "VITE_STAGE")
