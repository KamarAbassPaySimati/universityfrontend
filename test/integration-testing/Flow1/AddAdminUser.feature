...
Feature: Paymaart - Admin Web - Onboard Admin
  ...
  Scenario Outline: Onboard admin with different roles
    ...
    Examples: 
      | role            | message                                |
      | "Super admin"   | "Super admin onboarded successfully"   |
      | "Admin"         | "Admin onboarded successfully"         |
      | "Finance admin" | "Finance admin onboarded successfully" |
      | "Support admin" | "Support admin onboarded successfully" |
