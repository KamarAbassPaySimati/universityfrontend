...
When('I click on transaction history icon', async function () {
    ...
    const element = await driver.wait(until.elementLocated(By.css('[data-testid="transaction_history_view"]')));
...
Then('I should be navigated to transaction history page', async function () {
    const element = await driver.wait(until.elementLocated(By.css('[data-testid="transaction_history"]')));
    await driver.wait(until.elementIsVisible(element));
    ...
    const beneficiary_paymaart_id = await driver.wait(until.elementLocated(By.css('[data-testid="transaction_details"] [data-testid="beneficiary_paymaart_id"]'))).getText();
