...
Feature: Paymaart -Admin Web - Forgot Password
  ...
  Scenario: Check for password requirement
    ...
    * I enter current password as <current_password>
    ...
    Then I should see update password button as disabled
    Examples: 
      | current_password | password      | confirm_password |
      | "Admin@123"      | "abcpassword" | "abcpassword"    |
      | "Admin@123"      | "1"           | "1"              |
      | "Admin@123"      | "c"           | "c"              |
      | "Admin@123"      | "@"           | "@"              |
      | "Admin@123"      | "bharath@"    | "bharath@"       |
      | "Admin@123"      | "B"           | "B"              |
      | "Admin@123"      | "Ba"          | "Ba"             |
      | "Admin@123"      | "Ba1"         | "Ba1"            |
      | "Admin@123"      | "Pass!1"      | "Pass!1"         |

  Scenario: Set New Password with valid information
    Given I navigate to update password page
    When I enter current password as "Admin@123"
    When I enter new password as "Admin@1234" and confirm password as "Admin@1234"
  ...
  Scenario: Set password to previous password
    Given I navigate to update password page
    When I enter current password as "Admin@1234"
