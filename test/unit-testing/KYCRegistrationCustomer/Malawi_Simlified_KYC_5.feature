Feature: Paymaart - Admin Web - Onboard Customer(Malawi Simplified KYC)
    As an Super/support/admin, I want the ability to perform KYC Registration for Malawi Simplified new Customer
    ...
    Scenario: Upload invalid ID document details
        ...
        When I select the ID document as "Employee ID"
