...
#     @add_admin_user @create_new_user_and_login @get_agent_deactivate_kyc_list
...
#         When I enter the transaction amount as "10000" for suspense account transaction
...
#     @get_customer_delative_kyc_list
