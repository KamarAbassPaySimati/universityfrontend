Feature: Paymaart- Admin Web- Tax Account Transaction addition(WHT)

    As an super/finance admin, I want to add  the transactions in the Paymaart tax bank account, so that I have an previlege to move e-money to capital bank

    Condition of Satisfaction
    1.There should be an option to add transactions
    2.There should be an option to slect from the list of type and enter the amount
    3.The entry should reflect in capital bank account
