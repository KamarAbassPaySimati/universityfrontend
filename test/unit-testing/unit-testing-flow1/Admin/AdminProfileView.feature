...
Feature: Paymaart - Admin Web -Profile View
    ...
    Scenario: Super admin login and view profile
    ...
    @create_new_user_and_login
    @delete_admin_account
    Scenario: Finance admin login and view profile
        Given I am logged into the application
        When I navigate to my profile page
        Then I should see my profile card information
        And I should see my name
    ...
    @create_new_user_and_login
    @delete_admin_account
    Scenario: Support admin login and view profile
        Given I am logged into the application
        When I navigate to my profile page
        Then I should see my profile card information
        And I should see my name
    ...
    @create_new_user_and_login
    @delete_admin_account
    Scenario: Normal admin login and view profile
        Given I am logged into the application
        When I navigate to my profile page
        Then I should see my profile card information
        And I should see my name
